...
abstract class AbstractContextFormatter extends NormalizerFormatter
{
     ...
     */
    public function __construct($dateFormat = null, $application = null, $defaultCategory = null)
    {
     ...
     * @return string
     */
    abstract protected function formatContext(array $vars, array $context);
     ...
     * @return array
     */
    protected function buildTopLevelArrayNestedForContext(array $context)
    {
     ...
     *
     * @param array $context    by reference
     */
    protected function setSpecialProperties(array &$context)
    {
        if ($this->application) {
